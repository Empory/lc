...
class MainAdminController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $unapproveopinion = Post::approve('no')->byLanguage()->byType('opinion')->count();
        ...
        $waitapprove = Post::approve('no')->byLanguage()->take(50)->get();
        ...
        View::share(
            [
                ...
                'total_approve' => $unapprovenews + $unapproveopinion + $unapprovelists + $unapprovepolls + $unapprovevideos,
