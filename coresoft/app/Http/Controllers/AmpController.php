...
class AmpController extends Controller
{
    ...
    public function index()
    {
        ...
        $lastFeaturestop = Post::notInOpinion()->where('show_in_breaking_news', 1)->byPublished()->byLanguage()->byApproved()->orderByDesc('published_at')->take(8)->get();
    ...
    {
        $post = Post::with('user')->where('slug', $slug)->byPublished()->firstOrFail();
