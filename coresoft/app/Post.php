...
class Post extends Model
{
    ...
    protected $fillable = [
        ...
        'one_day_stats', 'seven_days_stats', 'thirty_days_stats', 'all_time_stats', 'raw_stats','main_slide_image',
        'show_in_main_slide','show_in_main_slide_2','show_in_breaking_news','show_in_home_videos','haber_guncelleme'
    ];

    protected $dates = ['created_at', 'featured_at', 'published_at', 'deleted_at', 'haber_guncelleme'];
    ...
    /**
     * Get post NotInOpinion
     *
     * @param  $query
     * @return mixed
     */
    public function scopeNotInOpinion($query)
    {
    ...
    public function forceDelete()
    {
        ...
        if (!empty($this->main_slide_image)) {
            $imageM = new UploadManager();
            $imageM->delete(makepreview($this->main_slide_image, 'b', 'posts'));
            $imageM->delete(makepreview($this->main_slide_image, 's', 'posts'));
        }
