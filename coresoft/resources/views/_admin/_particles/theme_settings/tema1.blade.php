        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        {!! Form::select($config_prefix.'SiteHeadlineStyle', ['1' => 'Style 1 - Boxes', '3' => 'Style 2 - Boxes', '4' => 'Style 3 - Tall Boxes', '5' => 'Style 4 - Two Big Boxes', '2' => 'Style 5 - Slider Type', '6' => 'Style 6 - Triple Type', 'off' => 'No Headline Post'], get_buzzy_config_by_theme($theme, 'SiteHeadlineStyle'), ['class' => 'form-control'])  !!}
