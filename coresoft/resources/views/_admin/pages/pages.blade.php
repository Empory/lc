            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="full_page" id="full_page" class="form-control">
                            <option value="0" {{ (@$page->full_page == 0) ? 'selected' : '' }}>Normal</option>
                            <option value="1" {{ (@$page->full_page == 1) ? 'selected' : '' }}>Tam Sayfa</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label>Aktif</label>
                        <select name="aktif_mi" id="aktif_mi" class="form-control">
                            <option value="0" {{ (@$page->aktif_mi == 0) ? 'selected' : '' }}>Pasif</option>
                            <option value="1" {{ (@$page->aktif_mi == 1) ? 'selected' : '' }}>Aktif</option>
