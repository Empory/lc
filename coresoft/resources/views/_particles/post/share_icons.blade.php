...
<div class="content-share">
    ...
    <a class="content-share__item whatsapp buzz-share-button hide-phone" data-type="news" data-id="{{ $post->id }}" data-share-type="whatsappweb" data-post-url="{{ route('post.share') }}" data-title="{{ $post->title }}" data-sef="{{  $post->post_link }}">
        <div class="content-share__icon whatsapp-white"></div>
        @if(isset($post->shared->whatsappweb))
            <div class="content-share__badge buzz-share-badge-whatsapp hide-phone">{{ $post->shared->whatsappweb }}</div>
        @endif
    </a>
