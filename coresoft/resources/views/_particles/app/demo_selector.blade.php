    ...
    <div  class="demo-drawer-content clearfix">
        <div class="demo-thumb-wrapper">
            <a href="{{ url('/?theme=modern') }}" title="Modern Buzzy Theme">
                <img src="" height="300" width="300" class="img-responsive" alt="Modern Buzzy Theme">
            </a>
        ...
        <div class="demo-thumb-wrapper">
            <a href="{{ url('/?theme=tema1') }}" title="Tema1">
                <img src="#https://cdn.akbilisim.com/products/buzzy-laravel/images/themes/viralmag.jpg" height="300" width="300" class="img-responsive" alt="Tema1">
            </a>
            <span>Tema1</span>
        </div>
        <div class="demo-thumb-wrapper">
