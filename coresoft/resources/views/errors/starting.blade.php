...
<div class="buzz-container">
    <div class="global-container container starting text-center">
            ...
            <div class="modeempty_text">
                ...
                <p>
                    ...
                    <div class="loginat">
                        ...
                        Password: <u>admin</u>
                        <br>
                        <small>Login form in the upper right corner of this page or <a href="{{route('login')}}">Click here to Login</a></small>
                        <div class="modeadmin_header">
                            <div class="modeadmin_text">
                                <p>Warning: You must change the administrator password in the user settings after logging in.</p>
                            </div>
                        </div>
                    </div>
                </p>
        ...
        <div class="copyright">
            ...
            <strong>Copyright &copy; {{now()->format('Y')}} <a href="https://pakajans.com.tr"
                    target="_blank"><b>pakajans</b></a>.</strong>
            All rights reserved.

            &nbsp;&nbsp;&nbsp;

            <b><a href="http://buzzy.pakajans.com" target="_blank">PakHaber</a></b> Version :
