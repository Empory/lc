...
return [
    ...
    */
    "post_types" => [
        ...
        'opinion' => ['name' => 'Opinion', 'icon' => 'pencil', 'trans' => 'index.opinion'],
    ...
    */
    "social_links" => [
        ...
        'whatsapp' => ['name' => 'Whatsapp', 'icon' => '/assets/images/social_icons/whatsapp.svg', 'number' => '0', 'trans' => 'follow_us_on', 'color' => '#25d366'],
